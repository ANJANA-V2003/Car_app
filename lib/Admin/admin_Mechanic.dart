...
class _AdminMechanicState extends State<AdminMechanic> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: FutureBuilder(future:FirebaseFirestore.instance.collection("Mechanic_register").doc(widget.id).get() ,
                              ...
                              child: Column(
                                ...
                                children: [
                                  Row(
                                    children: [
                                      Text(
                                        Mech_datas["Work_experience"] ?? "No data found",
                                        style: GoogleFonts.poppins(
                                            fontWeight: FontWeight.w300,
                                            color: Color(0xff7D7D7D),
                                            fontSize: 14.sp),
                              ...
                              child: Column(
                                ...
                                children: [
                                  Row(
                                    children: [
                                      Text(
                                        Mech_datas["Shop_name"] ?? "No data found",
                                        style: GoogleFonts.poppins(
                                            fontWeight: FontWeight.w300,
                                            color: Color(0xff7D7D7D),
                                            fontSize: 14.sp),
